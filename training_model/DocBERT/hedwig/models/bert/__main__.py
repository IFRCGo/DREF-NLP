...
from datasets.bert_processors.dref_processor import DREFProcessor
from datasets.bert_processors.ifrc_processor import IFRCProcessor
...
if __name__ == "__main__":
    ...
    if not args.trained_model:
        save_path = os.path.join(
            args.save_path, dataset_map[args.dataset].NAME
        )
    ...
    pretrained_model_path = (
        ...
        else PRETRAINED_MODEL_ARCHIVE_MAP[args.model]
    )
