...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='SST-2', choices=['SST-2', 'AGNews', 'Reuters', 'AAPD', 'IMDB', 'Yelp2014', 'IFRC', 'DREF'])
    ...
    parser.add_argument('--forcetag', default=0, type=int, help='force most likely tag if no tag is given')
