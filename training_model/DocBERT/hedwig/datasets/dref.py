...
def clean_string(string):
    """
    Performs tokenization and string cleaning for the DREF dataset
    """
...
class DREF(TabularDataset):
    ...
    @classmethod
    def splits(cls, path, train=os.path.join('DREF', 'train.tsv'),
               validation=os.path.join('DREF', 'dev.tsv'),
               test=os.path.join('DREF', 'test.tsv'), **kwargs):
        return super(DREF, cls).splits(
